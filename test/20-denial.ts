...
it("solves the challenge", async function () {
    let balance = await challenge.contractBalance();
    await challenge.setWithdrawPartner(attacker.address);
    // Trigger reentrancy
    await challenge.withdraw();
    balance = await challenge.contractBalance();
